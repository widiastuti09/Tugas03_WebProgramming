...
<html lang="en">
  ...
  <body>
    ...
    <h2 class="text-center mt-4">UBAH DATA USER</h2>
      ...
      <div class="col-lg-8 mt-4 mb-5">
        <form action="ubah.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" pattern="[A-Za-z ]+" name="username" class="form-control" required value="<?php echo $tampil->username ?>">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label>Email</label>
            <input type="text" name="email" class="form-control" required value="<?php echo $tampil->email ?>">
          </div>
          <div class="form-group">
            <label>TTL</label>
